...
class PiuLxio : public io::IODevice
{
public:
    PiuLxio();
...
private:
    struct InBuffer {
        ...
        uint8_t m_p1lu_menu : 1;
        uint8_t m_p1ru_menu : 1;
        uint8_t m_p1cn_menu : 1;
        uint8_t m_p1ld_menu : 1;
        uint8_t m_p1rd_menu : 1;

        uint8_t m_p2lu_menu : 1;
        uint8_t m_p2ru_menu : 1;
        uint8_t m_p2cn_menu : 1;
        uint8_t m_p2ld_menu : 1;
        uint8_t m_p2rd_menu : 1;
